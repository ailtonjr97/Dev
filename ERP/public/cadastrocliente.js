...
document.getElementsByClassName('btn-success')[0].addEventListener("click", function(event){
  document.getElementsByClassName('nome')[0].style.display = 'block';
  document.getElementsByClassName('cpfSome')[0].style.display = 'block';
  document.getElementsByClassName('rgSome')[0].style.display = 'block';
  document.getElementsByClassName('cnpjSome')[0].style.display = 'none';
  document.getElementsByClassName('razaoSocial')[0].style.display = 'none';
})

document.getElementsByClassName('btn-success')[1].addEventListener("click", function(event){
  document.getElementsByClassName('razaoSocial')[0].style.display = 'block';
  document.getElementsByClassName('nome')[0].style.display = 'none';
  document.getElementsByClassName('cpfSome')[0].style.display = 'none';
  document.getElementsByClassName('rgSome')[0].style.display = 'none';
  document.getElementsByClassName('cnpjSome')[0].style.display = 'block';
})
