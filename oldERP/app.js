...
app.get('/pedidodecompra.html', function(req, res){
  res.sendFile(__dirname + '/pedidodecompra.html')
})

app.get('/cotacao.html', function(req, res){
  res.sendFile(__dirname + '/cotacao.html')
})
